...
public class SuccessAuthHandler implements AuthenticationSuccessHandler {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SuccessAuthHandler.class);
    ...
    protected String determineTargetUrl(final Authentication authentication) {
        ...
        roleTargetUrlMap.put("ROLE_USER", "/shop");
        roleTargetUrlMap.put("ROLE_ADMIN", "/shop");
        roleTargetUrlMap.put("ROLE_SUPER_ADMIN", "/shop");
